...
class BookAPITestCase(APITestCase):
    ...
    def test_retrieve_book_detail(self):
        ...
        self.assertEqual(resp.status_code, status.HTTP_200_OK)
        self.assertEqual(resp.json().get("title"), self.book1.title)

    # Create view permissions and behavior
    ...
    # Update view permissions and behavior
    ...
    # Delete view permissions and behavior
